...
// here in this we change all the text and containers add some dark mode on it by mainly using state and props
// if u have to chnage any thing inti string just put it into {` `} middle bracket and bactis if u want to change inside the string then use ${} inside {`${}`}
// we use 'Link' instead of 'a' and 'to' insted of 'href' for no reloding 
